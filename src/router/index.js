...
const routes = [
    ...
    //NHÓM ROUTE CHO ADMIN
    {
        ...
        children: [
            ...
            { path: 'profile', component: () => import('../components/Admin/Profile/index.vue') },
        ]
    },
    {
        path: '/admin/login', component: () => import('../components/Admin/Login/index.vue'),
        meta: { layout: "blank" },
    },
    {
        path: '/admin/reset-password',
        component: () =>
            import('../components/Admin/QuenMatKhau/index.vue'),
        meta: { layout: "blank" },
    },
    {
        path: '/admin/doi-mat-khau/:hash_reset',
        component: () =>
            import('../components/Admin/DoiMatKhau/index.vue'),
        meta: { layout: "blank" },
        props: true
    },
